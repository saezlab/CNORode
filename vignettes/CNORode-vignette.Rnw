...
data("PKN-ToyPB.RData", package="CNORode")
data("MD-ToyPB.RData", package="CNORode")
...
plotLBodeFitness(cnolist = cnolist, model = model, 
...
R=crossvalidateODE(CNOlist = cnolist, model = model, 
